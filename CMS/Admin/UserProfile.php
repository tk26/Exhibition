...
// var sex = document.getElementById('sex').value;
 ...
 ajaxRequest.open("GET", "updateUserProfileAdmin.php" + 
                              queryString, true);
...
function ajaxFunction2(){
 ...
 ajaxRequest.open("GET", "updateAdminPassword.php" + 
                              queryString, true);
 ajaxRequest.send(null); 
}
                ...
                <div class="span10 offset1">
                   ...
                   <div class="col-sm-10">
                      ...
                      <label class="control-label col-sm-2">Role</label>
                       <div class="col-sm-10">
                            <input name="role" id="role" type="text" class="form-control"  placeholder="User Role" disabled="true" value="Super User / Admin ">
