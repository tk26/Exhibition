...
<div class="control-group">
  <label class="control-label" for="lblOrganName">Organization Name</label>
  <div class="controls">
    <input id="lblOrganName" name="lblOrganName" type="text" placeholder="Name of Compnay"  class="form-control input-lg" required="">
...
<!-- Text input-->
<div class="control-group">
  <label class="control-label" for="lblPrimaryContact">Primary Contact</label>
  <div class="controls">
    <input id="lblPrimaryContact" name="lblPrimaryContact" type="text" placeholder="Enter name of POC"  class="form-control input-lg" required="">
...
<!-- Text input-->
<div class="control-group">
  <label class="control-label" for="lblEmail">Email Id</label>
  <div class="controls">
    <input id="lblEmail" name="lblEmail" type="text" placeholder="Enter Email Id of POC"  class="form-control input-lg" required="">
  
  </div>
</div>
<hr class="colorgraph">
			<div class="row">
				<div class="col-xs-12 col-md-6"><input type="submit" value="Create Organization" class="btn btn-primary btn-block btn-lg" tabindex="7"></div>
